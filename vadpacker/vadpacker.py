...
# Copyright (C) 2005-2016 OpenLink Software <opensource@openlinksw.com>
#
...
def main():
    ...
    optparser = optparse.OptionParser(usage="vadpacker.py [-h] --output PATH [--verbose] [--prefix PREFIX] [--targetprefix PREFIX] [--var [VAR [VAR ...]]] stickertmpl [files [files ...]]",
                                      ...
                                      description="(C) 2016 OpenLink Software. Vadpacker can be used to build Virtuoso VAD packages by providing the tool with a sticker template file. Vadpacker supports variable replacement and wildcards for file resources.",
