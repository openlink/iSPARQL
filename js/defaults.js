...
iSPARQL.Defaults = {
    ...
    followPropertiesList: [
        ['foaf:knows', 'http://xmlns.com/foaf/0.1/', true],
    ...
    tab: 0,
    anchorMode: 0,
    /* 0:Exec SPARQL describe, 1:get data items,2:Open in new window,3:Open "describe" page */
    maxrows: 50,
    view: 1,
    endpoint: '/sparql',
    ...
    raw_iris: true,
    locOpts: {
        /* XXX all except minAcc not implemented yet */
        cacheLocTO: 2000,
        /* Milliseconds timeout to improve non-expired cached location accuracy */
        coarseLocTO: 2000,
        /* Milliseconds to wait for coarse loc in last cached location validation attempt */
        minAcc: 500,
        /* default min. accuracy requested for location queries, in metres, after which the query fires */
        autoApply: true,
        /* Automatically execute location query when min. accuracy is achieved. */
    ...
    init: function() {
        var o = {
            async: false,
            onerror: function() {
                iSPARQL.StatusUI.statMsg("Warning: Could not get server defaults.")
            },
            onstart: function() {
                return;
            }
