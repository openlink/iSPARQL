...
iSPARQL.Location = function(o) {
    ...
    this.getAltAcc = function() {
        return self.altacc;
    }
    this.getCdate = function() {
        return self._cdate;
    }
    this.getMdate = function() {
        return self._mdate;
    }
    ...
    this.setAltAcc = function(altacc) {
        self._altacc = _altacc;
        self.touch();
        return _altacc;
    };
    ...
    this.notImplemented = function(m) {
        throw (new iSPARQL.E_MethodNotImplemented(self, m));
    }

    this.triplify = function() {
        self.notImplemented("triplify");
    };
    this.fromRDFItem = function() {
        self.notImplemented("fromRDFItem");
    };
    this.toRDFItem = function() {
        self.notImplemented("toRDFItem");
    };
    ...
    this._useHandler = function(e, s) {
        ...
        switch (self._uiMode) {
            case iSPARQL.locAcquireUIMode.MANUAL:
                var l = new iSPARQL.Location({
                    lat: self._latI.value,
